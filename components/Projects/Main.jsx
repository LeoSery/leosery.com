...
//             {viewMode === "default" 
//               ? `Showing ${filteredAndGroupedProjects.length} of ${projectsData.length} projects`
//               : `Showing ${filteredAndGroupedProjects.groups?.reduce((acc, group) => acc + group.projects.length, 0)} of ${projectsData.length} projects`
//             }
//         </p>
//         </div>
