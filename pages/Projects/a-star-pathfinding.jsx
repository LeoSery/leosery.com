import ProjectImg from "/public/static/projects/AStarPathFinding.png";
import { RiRadioButtonFill } from "react-icons/ri";
import Image from "next/image";
import Link from "next/link";
import React from "react";

export default function AstarPathfindingPageContent() {
  return (
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-20 p-2">
          <h2 className="py-2">A-star Pathfinding</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <a
            href="https://github.com/LeoSery/AStar-PathFinding--UnrealEngine5-2024"
            target="_blank"
            rel="noreferrer"
          >
