import ProjectImg from "/public/static/projects/ArLabProject.png";
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="text-justify py-2 text-gray-600 dark:text-[#B1AAA0]">
            AR Lab est une application de réalité augmentée que j'ai développée
            lors de mon alternance en 3ème année chez YZAR. Elle permet aux
            professionnels de la vente, aux intervenants techniques et aux
            formateurs de visualiser de manière interactive des produits et des
            concepts.
          </p>
          <a
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl dark:bg-[#1E1E1E] shadow-gray-400 dark:shadow-gray-800 rounded-xl py-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-800 py-2 flex items-center dark:text-[#B1AAA0]">
                <RiRadioButtonFill className="pr-1" /> Vuforia Engine
              </p>
              <p className="text-gray-800 py-2 flex items-center dark:text-[#B1AAA0]">
