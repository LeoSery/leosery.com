import ProjectImg from "/public/assets/projects/EarthSaver.png";
    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-20 p-2">
          <h2 className="py-2">Earth Saver</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="text-justify py-2 text-gray-600">
            Game made during the year 2019 to have fun and learn Unity3D. Small
            low poly game, where the goal is to dodge meteorites to prevent them
            from hitting the planet earth. In this project, you can drag the
            planet with your mouse to move it. You have to make the meteorites
            fall into the water. If meteorites fall on continents, humanity
            loses life. If the life of humanity reaches 0%, you lose.
          </p>
          <a
            href="https://github.com/LeoSery/EarthSaver--Unity3D-2019"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-800 py-2 flex items-center">
                <RiRadioButtonFill className="pr-1" /> Visual Studio Code
              </p>
            </div>
          </div>
        </div>
