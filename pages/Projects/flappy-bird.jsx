import ProjectImg from "/public/assets/images/projects/FlappyBirdGame.png";
    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-20 p-2">
          <h2 className="py-2">Flappy Bird</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="text-justify py-2 text-gray-600 dark:text-[#B1AAA0]">
            ...
            at Ynov Bordeaux. In this flappy bird realized under unity, you will
            have to dodge the pipes which arrives not your right while pressing
            on the space key. The pipes can arrive with different heights. You
            score points when you manage to cross pipes without colliding with
            one, if you collide with one, you lose.
          </p>
          <a
            href="https://github.com/LeoSery/FlappyBird--Unity3D-2022"
            target="_blank"
            rel="noreferrer"
          >
