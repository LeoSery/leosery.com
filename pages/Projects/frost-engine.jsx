import ProjectImg from "/public/static/projects/FrostEngineProject.png";
import { RiRadioButtonFill } from "react-icons/ri";
import Image from "next/image";
import Link from "next/link";
import React from "react";

export default function FrostEnginePageContent() {
  return (
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-20 p-2">
          <h2 className="py-2">Frost Engine</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          Frost Engine is a game engine written in C++. It is based on the Entity Component System approach.
          It uses OpenGL for graphics rendering and Dear ImGui for the editor.
          This project was carried out as part of a school project for my Master 1 year.
          </p>
          <div className="flex justify-start">
          <a
            href="https://github.com/LeoSery/FrostEngine--OpenGL-2024"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://leosery.github.io/FrostEngine--OpenGL-2024/"
            target="_blank"
            rel="noreferrer"
          >
            <div className="flex text-2xl">
              <button className="px-8 py-2 mt-4 mr-8 cursor-pointer bg-blue-600 text-white hover:shadow-lg hover:shadow-[#312f2f] hover:scale-105 hover:bg-[#ff9f1c] rounded-md text-sm font-medium capitalize">
                <p>View engine documentation</p>
              </button>
            </div>
          </a>
          </div>
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl dark:bg-[#1E1E1E] shadow-gray-400 dark:shadow-gray-800 rounded-xl py-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-800 py-2 flex items-center dark:text-[#B1AAA0]">
                <RiRadioButtonFill className="pr-1" /> OpenGL
              </p>
              <p className="text-gray-800 py-2 flex items-center dark:text-[#B1AAA0]">
                <RiRadioButtonFill className="pr-1" /> GLFW
              </p>
              <p className="text-gray-800 py-2 flex items-center dark:text-[#B1AAA0]">
                <RiRadioButtonFill className="pr-1" /> glm
              </p>
            </div>
          </div>
        </div>
