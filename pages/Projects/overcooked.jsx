import ProjectImg from "/public/static/projects/OverCoockedGame.png";
import { RiRadioButtonFill } from "react-icons/ri";
import Image from "next/image";
import Link from "next/link";
import React from "react";

export default function OvercookedPageContent() {
  return (
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-20 p-2">
          <h2 className="py-2">Overcooked</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="text-justify py-2 text-gray-600 dark:text-[#B1AAA0]">
            Game made during my bachelor 3 year (2022/2023) for a Unity3D module
            at Ynov Bordeaux. You play as a character who can use the
            ingredients at his disposal to make the recipes that arrive. You
            need to get the vegetables from a vending machine and then cut them.
            Then if the vegetable can be cooked, you need to put it in a pan and
            then put the pan on the stovetop to cook the ingredient. Once your
            ingredient is cooked, you can put it on a plate, so you can combine
            it with other foods. Once your plate contains all the ingredients
            called for in the recipe, you can take the dish to the delivery
            counter.
          </p>
          <a
            href="https://github.com/LeoSery/Overcooked--Unity3D-2022"
            target="_blank"
            rel="noreferrer"
          >
