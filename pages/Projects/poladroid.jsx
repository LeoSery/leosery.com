import ProjectImg from "/public/static/projects/PoladroidGame.png";
import { RiRadioButtonFill } from "react-icons/ri";
import Image from "next/image";
import Link from "next/link";
import React from "react";

export default function PoladroidPageContent() {
  return (
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-20 p-2">
          <h2 className="py-2">Poladroïd</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          Poladroid is a TPS-camera traversal/stealth game in which the player takes on the role of a small robot. The action takes place in a near-future,
          dystopian Futurism, in a world seeking to break away from its roots. The character is one of the last of his kind, embodying the old world, but rejected and hunted.
          ...
          <a
            href="https://leosery.itch.io/poladroid"
            target="_blank"
            rel="noreferrer"
          >
            <div className="flex text-2xl">
              <button className="px-8 py-2 mt-4 mr-8 cursor-pointer bg-blue-600 text-white hover:shadow-lg hover:shadow-[#312f2f] hover:scale-105 hover:bg-[#ff9f1c] rounded-md text-sm font-medium capitalize">
                <p>See game on itch.io</p>
              </button>
            </div>
          </a>
          <a
            href="https://github.com/LeoSery/Project-Poladroide--UnrealEngine5-2024"
            target="_blank"
            rel="noreferrer"
          >
            <div className="flex text-2xl">
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl dark:bg-[#1E1E1E] shadow-gray-400 dark:shadow-gray-800 rounded-xl py-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-800 py-2 flex items-center dark:text-[#B1AAA0]">
                <RiRadioButtonFill className="pr-1" /> Rider
              </p>
            </div>
          </div>
        </div>
