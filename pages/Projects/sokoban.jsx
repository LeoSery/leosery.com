import ProjectImg from "/public/static/projects/SokobanGame.png";
import { RiRadioButtonFill } from "react-icons/ri";
import Image from "next/image";
import Link from "next/link";
import React from "react";

export default function SokobanPageContent() {
  return (
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p className="text-justify py-2 text-gray-600 dark:text-[#B1AAA0]">
            ...
            at Ynov Bordeaux. In this sokoban type game, your goal is to move
            your character to push the crates to reach the markers on the
            ground. Once all the crates are placed on the ground, you have won.
          </p>
          <a
            href="https://github.com/LeoSery/Sokoban--Unity3D-2022"
            target="_blank"
            rel="noreferrer"
          >
