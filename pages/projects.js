...
export default function Projects() {
  ...
  return (
    <>
      <SEO
        title="Projects"
        description="Browse through Leo Séry's game development portfolio. From game engines to complete games, discover projects built with Unity3D, Unreal Engine, and custom technologies."
